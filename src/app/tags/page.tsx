    ...
    <div className="flex h-screen bg-gray-50 overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto">
        ...
        <div className="max-w-2xl mx-auto px-6 py-8 space-y-3">
          {/* Create new tag */}
          {canManage && (
            <div className="bg-white border border-dashed border-green-300 rounded-xl p-4 flex items-center gap-3">
              <input
                value={newIcon}
          ...
          {tags.map((tag) => {
            ...
            return (
              <div key={tag.id} className="bg-white border border-gray-100 rounded-xl px-4 py-3 flex items-center gap-3 hover:border-green-200 transition-colors">
                {isEditing ? (
                  <>
